 ...
 */
function contactsummarymembershipreport_civicrm_xmlMenu(&$files) {
  _contactsummarymembershipreport_civix_civicrm_xmlMenu($files);
}
 ...
 */
function contactsummarymembershipreport_civicrm_managed(&$entities) {
  _contactsummarymembershipreport_civix_civicrm_managed($entities);
}
 ...
 */
function contactsummarymembershipreport_civicrm_caseTypes(&$caseTypes) {
  _contactsummarymembershipreport_civix_civicrm_caseTypes($caseTypes);
}
 ...
 */
function contactsummarymembershipreport_civicrm_angularModules(&$angularModules) {
  _contactsummarymembershipreport_civix_civicrm_angularModules($angularModules);
}
 ...
 */
function contactsummarymembershipreport_civicrm_alterSettingsFolders(&$metaDataFolders = NULL) {
  _contactsummarymembershipreport_civix_civicrm_alterSettingsFolders($metaDataFolders);
}
 ...
 *
function contactsummarymembershipreport_civicrm_preProcess($formName, &$form) {
